...
Засчет этого, в дочерних шаблон перенесутся строки из родительского.

> Выражение super не обязательно должно находится в самом начале блока. Оно может быть в любом месте блока.
...
Мы рассмотрели все основные возможности Jinja2.
