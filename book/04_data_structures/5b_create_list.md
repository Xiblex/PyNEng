...
После 6 раздела, можно вернуться к этой теме и почитать о них подробнее в разделе [Примеры использования основ](../08_python_basic_examples/x_comprehensions.md).
