...
> В версии 2.2.1.0 были внезены изменения из-за которых часть функционала работает с ошибками. Скорее всего, это скоро исправят, но при моей последней проверке (06.02.2017), были проблемы.
