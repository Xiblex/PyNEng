...
Когда в интерпретаторе создается, например, цикл (будет рассматриваться позже), то внутри цикла приглашение меняется на ```...```.
...
> Как выполнять скрипты мы посмотрим позже.
