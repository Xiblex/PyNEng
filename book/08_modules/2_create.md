...
Попробуем, для примера, использовать скрипт из раздела [Совмещение for и if](../05_control_structures/2b_for_if.md).
Разнесем шаблоны портов, данные и формирование команд в разные файлы.
