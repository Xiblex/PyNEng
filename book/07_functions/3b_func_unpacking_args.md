...
Для примера, используем функция config_interface (файл func_args_var_unpacking.py): 
```python
...
Если теперь нужно вызвать функцию передав на вход информацию, полученную из другого источника, например из БД.
