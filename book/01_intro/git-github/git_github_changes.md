...
* По желанию, можно нажать галочку "Initialize this repository with a README". Это создасть файл README.md, в котором будет находиться только название репозитория

![create](https://raw.githubusercontent.com/natenka/PyNEng/python3.6/images/git/github_new_repo.png)

## Копирование репозитория с GitHub

Для работы с созданным репозиторием локально, его нужно скопировать.
