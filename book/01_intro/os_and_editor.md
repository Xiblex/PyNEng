...
Для начала работы можно взять первый из списка для соответствующей операционной системы. Далее выводы команд, интерпретатора и скриптов выполняются на Linux. В других ОС вывод может незначительно отличаться.
