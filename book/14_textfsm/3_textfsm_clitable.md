...
Благодаря TextFSM, мы можем обрабатывать вывод команд и получать структурированный результат. 
Но, у нас всё ещё есть ограничения: нам надо вручную прописывать каким шаблоном обрабатывать команды show, каждый раз, когда мы используем TextFSM.
