...
Если количество IP-адерсов, которые нужно проверить, большое, можно использовать модуль multiprocessing, чтобы ускорить проверку.

> Это вынесено в задания к разделу.

Это далеко не все возможности модуля subprocess.
Подробнее о нём вы можете почитать в [документации](https://docs.python.org/2/library/subprocess.html) или [в статье PyMOTW](https://pymotw.com/2/subprocess/index.html)
