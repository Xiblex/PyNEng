...
Insert a blank line after the 'Time' value definition.
...
Because of the successful match, each of the Values associated with the group will be assigned the matching text.
