...
Например, разделим скрипт из раздела [Совмещение for и if](../06_control_structures/2b_for_if.md) на несколько частей: шаблоны портов, данные и формирование команд будут в разных файлах.
