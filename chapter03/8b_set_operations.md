...
Объединение множеств можно получить с помощью метода __union()__ или оператора __|__:
```python
...
Пересечение множеств можно получить с помощью метода __intersection()__ или оператора __&__:
```python
