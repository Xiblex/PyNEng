...
* [7. Функции](book/07_functions/README.md)
    ...
    * [Аргументы функций](book/07_functions/3_func_args.md)
        * [Типы аргументов](book/07_functions/3a_func_args_types.md)
        * [Аргументы переменной длинны](book/07_functions/3b_func_args_var_len.md)
...
* [15. Ansible](book/15_ansible/README.md)
    * [Основы Ansible](book/15_ansible/1_ansible_basics.md)
        * [Инвентарный файл](book/15_ansible/1a_inventory.md)
        * [Ad-Hoc команды](book/15_ansible/1b_ad-hoc.md)
        * [Конфигурационный файл](book/15_ansible/2_configuration.md)
        * [Модули](book/15_ansible/3c_modules.md)
