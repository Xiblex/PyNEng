...
* [Основы Python](book/01_intro/README.md)
...
* [Повторное использование кода](book/07_functions/README.md)
  ...
  * [Полезные модули](book/08_modules/useful_modules/README.md)
    ...
    * [Модуль tabulate](book/08_modules/useful_modules/tabulate.md)
    * [Модуль pprint](book/08_modules/useful_modules/pprint.md)
    * [Дополнительные материалы](book/08_modules/further_reading.md)
  * [Итераторы, генераторы списков, словарей и множеств](book/16_additional_info/iterator_generator/README.md)
    * [Итерируемый объект, итератор](book/16_additional_info/iterator_generator/iterable_and_iterator.md)
    * [List, dict, set comprehensions](book/16_additional_info/iterator_generator/x_comprehensions.md)
...
* [Запись и передача данных](book/10_serialization/README.md)
  * [Unicode](book/16_additional_info/unicode/README.md)
    * [Стандарт Unicode](book/16_additional_info/unicode/unicode_standard.md)
    * [Unicode в Python 3](book/16_additional_info/unicode/python_3_unicode.md)
    * [Конвертация между байтами и строками](book/16_additional_info/unicode/python_3_convert.md)
    * [Примеры конвертации](book/16_additional_info/unicode/convert_examples.md)
    * [Ошибки при конвертации](book/16_additional_info/unicode/errors.md)
    * [Дополнительные материалы](book/16_additional_info/unicode/further_reading.md)
  * [10. Работа с файлами в формате CSV, JSON, YAML](book/10_serialization/README.md)
...
* [Работа с сетевым оборудованием](book/12_ssh_telnet/README.md)
  ...
  * [Одновременное подключение к нескольким устройствам](book/12_ssh_telnet/5_simultaneous_connections.md)
    ...
    * [Модуль concurrent.futures](book/12_ssh_telnet/concurrent_futures/README.md)
      * [Метод map](book/12_ssh_telnet/concurrent_futures/concurrent_futures_map.md)
      * [Метод submit](book/12_ssh_telnet/concurrent_futures/concurrent_futures_submit.md)
    * [Дополнительные материалы](book/12_ssh_telnet/further_reading.md)
    * [Задания](exercises/12_ssh_telnet/12_exercises.md)
  * [13. Шаблоны конфигураций с Jinja2](book/13_jinja2/README.md)
    * [Пример использования Jinja2](book/13_jinja2/1_example.md)
    * [Программный интерфейс Jinja2](book/13_jinja2/2_example.md)
  ...
  * [14. Обработка вывода команд TextFSM](book/14_textfsm/README.md)
...
* [Ansible](book/15_ansible/README.md)
