...
В этом случае начните с [Ansible](book/Part_VI.md). Для установки этой системы контроля конфигурации и её базового использования, не требуется знать Python. Достаточно установить Ansible, взять пример использования и попробовать выполнить команды на оборудовании, например команды show. После этого можно использовать Ansible для отправки команд кофигурации, которые не влияют на передачу трафика, таких как:
