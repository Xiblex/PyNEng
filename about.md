...
[Пятый раздел](book/05_control_structures/README.md) посвящен контролю хода программы: условиям (if/else), циклам (for, while) и работе с исключениями. А в [шестом разделе](book/06_files/README.md), мы завершаем знакомство с основами Python, принципами работы с файлами.
...
В [одинадцатом разделе](book/11_db/README.md) рассматриваюется работа с базами данных, на примере SQLite.
